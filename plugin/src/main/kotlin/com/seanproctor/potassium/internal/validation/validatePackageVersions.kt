...
import com.seanproctor.potassium.internal.packageBuildVersionFor
import com.seanproctor.potassium.internal.packageVersionFor
...
internal fun JvmApplicationContext.validatePackageVersions() {
    ...
    for (targetFormat in app.nativeDistributions.currentOsTargetFormats) {
