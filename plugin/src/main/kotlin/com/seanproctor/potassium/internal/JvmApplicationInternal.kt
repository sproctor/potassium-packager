...
internal open class JvmApplicationInternal
    ...
    constructor(
        ...
        // Packaging config is now exposed at the root `potassium { }` level (see PotassiumExtension),
        // not as a nested `nativeDistributions { }` block. This internal accessor remains for the
        // plugin's own use.
        internal val nativeDistributions: JvmApplicationDistributions by data::nativeDistributions
